...
| 移动端 | 福彩详细推导 | 体彩详细推导 | 历史与结算展开 |
|--------|-------------|-------------|---------------|
| ![移动端](./screenshots/4.png) | ![福彩详细推导](./screenshots/5.png) | ![体彩详细推导](./screenshots/6.png) | ![历史与结算展开](./screenshots/7.png) |
...
生成桌面首页、气运断势、起卦后页面、详细推导、移动端和展开列表截图：
...
└── screenshots/        # 效果图
    └── 1-8.png         # 首页、气运、起卦、推导、移动端和历史结算截图
```
