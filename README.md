...
基于梅花易数时间起卦的彩票号码娱乐工具。页面已调整为「起卦工作台 + 预测记录 + 历史归档」的新版界面，起卦、变卦、互卦和体用关系尽量按传统规则保持自洽，福彩双色球和体彩大乐透分别生成可解释、可复现的号码。
...
- 🎨 **新版工作台 UI**：深色页头、圆形易印、双栏起卦工作台和分区档案面板
- 🧾 **清晰信息架构**：今日气运、起卦测号、当前预测、历史中奖和历史预测分区展示
- 📱 **响应式设计**：桌面双栏展示，移动端自动压缩为单列
